const Footer = () => {
  return (
    // <div className="bg-black text-white px-[200px] h-[60vh] mt-[40px]">
    //   {/* UPPER PART */}
    //   <div className="flex justify-between py-[5%]">
    //     <div>
    //       <img src="/logoInchoo.png" alt="Logo" height={200} width={200} />
    //       <p className="mt-2">
      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            ...
            <img src="/logoInchoo.png" class="h-8 me-3" alt="inchoo Logo" />
            {/* </a> */}
          </div>
